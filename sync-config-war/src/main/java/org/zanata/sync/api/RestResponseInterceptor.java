...
//
//
public class RestResponseInterceptor implements ContainerResponseFilter {
    private static final String ZANATA_ORIGIN_WHITELIST =
            "zanata.originWhitelist";
    private static final String ALLOW_METHODS =
            "PUT, POST, DELETE, GET, OPTIONS, HEAD";
    private static final ImmutableList<String> originWhitelist;

    static {
        String whitelist = System.getProperty(ZANATA_ORIGIN_WHITELIST, "http://localhost:8000");
    ...
    public void filter(ContainerRequestContext requestContext,
        ...
        if (!Strings.isNullOrEmpty(origin) &&
                originWhitelist.contains(origin)) {
            ...
            List<String> nextRequestHeaders =
