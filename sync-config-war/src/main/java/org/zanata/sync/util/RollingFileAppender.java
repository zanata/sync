...
/**
 * Overrides {@link ch.qos.logback.core.rolling.RollingFileAppender} to allow
 * {@link #append} action.
 *
...
public class RollingFileAppender<E> extends FileAppender<E> {
    ...
    private boolean fileAndPatternCollide() {
        if (triggeringPolicy instanceof RollingPolicyBase) {
            ...
            final FileNamePattern fileNamePattern = new FileNamePattern(base.getFileNamePattern(), base.getContext());
